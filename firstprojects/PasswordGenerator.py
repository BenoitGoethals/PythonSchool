...
lenght_letters=int(input("Enter your lenght letters: "))
lenght_numbers=int(input("Enter your lenght numbers: "))
lenght_symbols=int(input("Enter your lenght punctuation: "))
count_letters=0
count_numbers=0
count_symbols=0
password=""
